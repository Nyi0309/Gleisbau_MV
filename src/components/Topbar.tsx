                ...
                <div className="hidden xl:flex gap-6 items-center justify-between">
                    <div className="flex items-center gap-8">
                        ...
                        <div className="flex gap-4 items-center">
                            <div className="bg-primary w-8 h-8 flex items-center justify-center"><RiPhoneFill className="text-white text-xl" /></div>
                            <p className="hidden xl:block">+49 (0) 3981 34 94 48 - 5</p>
                        </div>
                        {/**mail */}
                        <div className="flex gap-2 items-center">
                            <div className="bg-primary w-8 h-8 flex items-center justify-center"><IoMdMail className="text-white text-xl" /></div>
                            <p className="hidden xl:block">info@gleisbau-mv.de</p>
                        </div>
                    </div>
                    {/**Pin */}
                    <div className="flex gap-2 items-center">
                        <div className="bg-primary w-8 h-8 flex items-center justify-center"><MdLocationPin className="text-white text-xl" /></div>
